...
st.header("Today's Predictions 12/5/2021:")
st.text("Spread Win/Loss: (82-102).446")
st.text("Over/Under Win Loss: (93-109).460")
st.text("Spread HIGH Confidence:(20-24).455")
st.text("Spread LOW Confidence:(25-27).481")
st.text("Totals HIGH Confidence:(30-28).517")
